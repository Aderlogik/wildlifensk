...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            var sCSSClass = "text_filter form-control-xs";
            if (bIsNumber)
                sCSSClass = "number_filter form-control-xs";
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input style="width:30%; display: inline;" type="text" class="number_range_filter form-control-xs" id="' + sFromId + '" rel="' + i + '"/>');
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input style="width:30%; display: inline;" type="text" class="number_range_filter form-control-xs" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            var r = '<select class="search_init select_filter form-control-xs" rel="' + i + '"><option value="" class="search_init">' + sLabel + '</option>';
			if(bMultiselect) {
		...
		function fnCreateDropdown(aData) {
			var index = i;
			var r = '<div class="dropdown select_filter form-control"><a class="dropdown-toggle" data-toggle="dropdown" href="#">' + label + '<b class="caret"></b></a><ul class="dropdown-menu" role="menu" "data-no-turbolink" => true><li data-value=""><a>Show All</a></li>', j, iLen = aData.length;
